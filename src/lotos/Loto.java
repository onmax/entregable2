...
@Programacion2 (
		nombreAutor1 = "Raúl",
		apellidoAutor1 = "Carbajosa González",
		emailUPMAutor1 = "raul.cgonzalez@alumnos.upm.es",
		nombreAutor2 = "Máximo",
		apellidoAutor2 = "García Martínez", 
		emailUPMAutor2 = "maximo.garcia.martinez@alumnos.upm.es"
		)
...
public class Loto
{
   ...
   *   @throws FueraDeRango si NO todosEnRango (numeros, min, max)
   *   eoc --> Construye una Loto
   */
  public Loto (int numerosSorteo, int[] numeros, int min, int max)
    throws BadSize, FueraDeRango
  {
    //TODO
  ...
  /*
   * POST: Determina si todos los <numeros> estan en el
   *       rango [min, max]
   */
  ...
  /*
   * PRE: pos IN [0,size()-1]
   * POST: devuelve el elemento del objeto que esta en la 
   *       posiciÃ³n "pos".
   */
  public int get (int pos)
  {
    int resultado = (pos >=0 && pos < this.size())?
    	 numeros[pos]: -1;
    return resultado;
  }
  /*
   * PRE: pos IN [0,size()-1]
   * POST: modifica el elemento del objeto que esta en la posiciÃ³n "pos".
   */
  ...
  /*
   * PRE: ganadora.size() == this.size()
   * POST: Decide si la Loto es igual a la "ganadora".
   */
...
/**
 * POST: resultado es cierto si "this" es igual a "otra" (mismos
 *       elementos en las mismas posiciones) y es falso e.o.c.
 */
  ...
  {
    return this.mismosNumeros(loto) &&
           min==loto.getMin() &&
           max==loto.getMax();
  }
  /*
