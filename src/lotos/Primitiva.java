...
{ 
  ...
  /*
   * PRE: numeros.length == 6 && 1 <= complementario <= 49 &&
   * 0<= reintegro <= 9 
   */
  public Primitiva (int[] numeros, int complementario, int reintegro) 
   ...
   * PRE: numeros.length == 6 && 1 <= complementario <= 49 &&
   * 0<= reintegro <= 9 
   * POST: Manejador del constructor de la Primitiva (si se cumple la PRE
   * se retorna una instancia de primitiva, si no se cumple se retorna null)
   */
   ...
   * POST: Decide si la Primitiva tiene el premio mayor:
   *       Que coincidan sus 6 numeros principales y el complementario
   *       con los de la "ganadora"
   */
  public boolean esGanadora (Primitiva ganadora)
  {   
    return 
      super.esGanadora(ganadora) &&
      complementario.getNumero() == ganadora.complementario.getNumero();
  ...
  {   
    return reintegro.getNumero() ==
      ganadora.getReintegro().getNumero();
  }
  /*
  ...
  {
    return 
      super.esIgual(primit) &&
      complementario.esIgual(primit.getComplementario()) &&
