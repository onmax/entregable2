...
/**
 * Fecha = (Entero dia, mes, anio) Representa una fecha como dia/mes/anio.
 * 
 * @since 4/02/2016
...
public class Fecha {
	...
	/**
	 * PRE: esFechaCorrecta() /\ f.esFechaCorrecta() POST: Determina si esta
	 * fecha es menor o igual que f en sentido cronológico.
	 */
